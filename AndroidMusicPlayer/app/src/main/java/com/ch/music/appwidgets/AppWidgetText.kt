    ...
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(R.drawable.ic_skip_next, ContextCompat.getColor(
                context, com.ch.appthemehelper.R.color.md_white_1000
            )).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_prev,
        ...
        appWidgetView.setTextColor(
            R.id.title, ContextCompat.getColor(context, com.ch.appthemehelper.R.color.md_white_1000)
        )
        appWidgetView.setTextColor(
            R.id.text, ContextCompat.getColor(context, com.ch.appthemehelper.R.color.md_white_1000)
        )
    ...
    override fun performUpdate(service: MusicService, appWidgetIds: IntArray?) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(playPauseRes, ContextCompat.getColor(
                service, com.ch.appthemehelper.R.color.md_white_1000)
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_next,
            service.getTintedDrawable(
                ...
                ContextCompat.getColor(
                    service,
                    com.ch.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
