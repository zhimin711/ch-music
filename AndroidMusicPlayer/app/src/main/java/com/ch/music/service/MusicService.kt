...
import com.ch.music.activities.LockScreenActivity
import com.ch.music.appwidgets.AppWidgetBig
import com.ch.music.appwidgets.AppWidgetCard
import com.ch.music.appwidgets.AppWidgetCircle
import com.ch.music.appwidgets.AppWidgetClassic
import com.ch.music.appwidgets.AppWidgetMD3
import com.ch.music.appwidgets.AppWidgetSmall
import com.ch.music.appwidgets.AppWidgetText
import com.ch.music.auto.AutoMediaIDHelper
import com.ch.music.auto.AutoMusicProvider
import com.ch.music.extensions.showToast
import com.ch.music.extensions.toMediaSessionQueue
import com.ch.music.extensions.uri
import com.ch.music.glide.BlurTransformation
import com.ch.music.glide.RetroGlideExtension.songCoverOptions
import com.ch.music.model.Song
import com.ch.music.model.smartplaylist.AbsSmartPlaylist
import com.ch.music.providers.HistoryStore
import com.ch.music.providers.MusicPlaybackQueueStore
import com.ch.music.providers.SongPlayCountStore
import com.ch.music.service.notification.PlayingNotification
import com.ch.music.service.playback.Playback
import com.ch.music.service.playback.Playback.PlaybackCallbacks
import com.ch.music.util.MusicUtil
import com.ch.music.util.PreferenceUtil.crossFadeDuration
import com.ch.music.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.ch.music.util.PreferenceUtil.isBluetoothSpeaker
import com.ch.music.util.PreferenceUtil.isBlurredAlbumArt
import com.ch.music.util.PreferenceUtil.isHeadsetPlugged
import com.ch.music.util.PreferenceUtil.isLockScreen
import com.ch.music.util.PreferenceUtil.isPauseOnZeroVolume
import com.ch.music.util.PreferenceUtil.playbackPitch
import com.ch.music.util.PreferenceUtil.playbackSpeed
import com.ch.music.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.ch.music.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.ch.music.util.PackageValidator
import com.ch.music.volume.AudioVolumeObserver
import com.ch.music.volume.OnAudioVolumeChangedListener
import com.bumptech.glide.Glide
import com.bumptech.glide.request.target.CustomTarget
import com.bumptech.glide.request.target.Target
import com.bumptech.glide.request.transition.Transition
import com.ch.music.glide.RetroGlideExtension.getSongModel
import com.ch.music.helper.ShuffleHelper.makeShuffleList
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    fun toggleFavorite() {
        serviceScope.launch {
            MusicUtil.toggleFavorite(currentSong)
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.ch.music"
