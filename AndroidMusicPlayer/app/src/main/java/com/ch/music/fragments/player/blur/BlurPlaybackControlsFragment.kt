 ...
 *
 */
package com.ch.music.fragments.player.blur
...
import com.ch.music.databinding.FragmentBlurPlayerPlaybackControlsBinding
...
class BlurPlaybackControlsFragment :
    ...
    override fun setColor(color: MediaNotificationProcessor) {
        ...
        lastDisabledPlaybackControlsColor =
            ContextCompat.getColor(requireContext(), com.ch.appthemehelper.R.color.md_grey_500)
