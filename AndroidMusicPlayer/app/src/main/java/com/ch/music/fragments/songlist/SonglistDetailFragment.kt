...
import com.ch.music.databinding.FragmentSonglistDetailBinding
...
import com.ch.music.netease.NeteaseAddToPlaylistDialog
        ...
        songAdapter = NeteaseStreamSongAdapter(
            ...
            onResolveError = { msg ->
                ...
                binding.errorMessage.text =
                    getString(R.string.failed_to_load_playlist, msg ?: "未知错误")
            },
            onLongClick = { song ->
                NeteaseAddToPlaylistDialog.show(this, song)
                true
            }
        )
