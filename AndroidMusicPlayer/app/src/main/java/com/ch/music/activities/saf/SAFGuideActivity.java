...
package com.ch.music.activities.saf;
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(com.ch.appthemehelper.R.color.md_deep_purple_300)
            .backgroundDark(com.ch.appthemehelper.R.color.md_deep_purple_400)
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(com.ch.appthemehelper.R.color.md_deep_purple_500)
            .backgroundDark(com.ch.appthemehelper.R.color.md_deep_purple_600)
            .layout(R.layout.fragment_simple_slide_large_image)
            .build());
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(com.ch.appthemehelper.R.color.md_deep_purple_700)
            .backgroundDark(com.ch.appthemehelper.R.color.md_deep_purple_800)
            .layout(R.layout.fragment_simple_slide_large_image)
            .build());
  }
}
