 ...
 *
 */
package com.ch.music.fragments.player.cardblur
...
import com.ch.music.databinding.FragmentCardBlurPlayerBinding
...
class CardBlurFragment : AbsPlayerFragment(R.layout.fragment_card_blur_player),
    ...
    private fun updateBlur() {
        ...
        Glide.with(this)
            ...
            .transform(
                BlurTransformation.Builder(requireContext()).blurRadius(PreferenceUtil.blurAmount.toFloat())
                    .build()
            )
