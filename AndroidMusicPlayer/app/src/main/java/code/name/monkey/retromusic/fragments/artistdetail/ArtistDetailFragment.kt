package code.name.monkey.retromusic.fragments.artistdetail
...
import code.name.monkey.retromusic.databinding.FragmentArtistDetailBinding
...
import code.name.monkey.retromusic.network.models.ArtistDetail
